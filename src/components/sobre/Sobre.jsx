        ...
        <div className="container">
            <div className="box">
                ...
                <h4>Sou natural de Conchal, São Paulo, e me mudei aos 16 anos (em 2014) para Campinas/SP. Me formei como Técnico em Mecatrônica e Assistente de Projetos e Processos Industriais Mecânicos pelo Colégio Técnico de Campinas (Cotuca - Unicamp), onde realizei 
                    também meu ensino médio. Iniciei minha graduação em 2019 em Engenharia Agrícola pela Unicamp. Em 2021, decido migrar de carreira após atuar por mais de 4 anos em Setor Industrial, tendo atuado com com manutenção, suporte operacional e planejamento de manutenções.</h4>
